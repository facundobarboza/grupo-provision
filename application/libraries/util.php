...
class Util {
  ...
  public function lowercase($str = NULL) {
    if( is_string($str) )
    {
      if( function_exists('mb_strtolower') )
        ...
        return strtr(strtolower($str), 'ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖØÙÜÚ','àáâãäåæçèéêëìíîïðñòóôõöøùüú');
    }
  ...
  public function comparar_fechas($fecha_a_comparar = NULL) {
    if( !is_null($fecha_a_comparar) )// si no es nulo el parámetro
    {
      $fecha2 = strtotime($fecha_a_comparar);// convierte una descripción de fecha/hora textual en Inglés a una fecha Unix
  ...
  public function firmaEmail($confiden = TRUE) {
    if( $confiden )
    {
      $confiden = 'NOTA DE CONFIDENCIALIDAD' . PHP_EOL .
                  ...
                  'las personas direccionadas en el mail, puede contener información de' . PHP_EOL .
                  'propiedad exclusiva de Coradir S.A. y/o amparada por el secreto profesional.' . PHP_EOL .
                  'El acceso no autorizado, uso, reproducción, o divulgación esta prohibido.' . PHP_EOL .
                  'Coradir S.A. no asumirá responsabilidad ni obligación legal alguna por' . PHP_EOL .
                  'cualquier información incorrecta o alterada contenida en este mensaje.' . PHP_EOL .
                  ...
                  'al remitente. No deberá utilizar, revelar, distribuir, imprimir o copiar' . PHP_EOL .
    ...
    $firma = PHP_EOL .
             ...
             'Dirección: ' . PHP_EOL .
             'Bs.As.: Tel/Fax: (011) y rotativas' . PHP_EOL .
             'Dirección: ' . PHP_EOL .
             'e-mail: info@gmail.com.ar' . PHP_EOL .
             'página: www.gmail.com.ar' . PHP_EOL;
