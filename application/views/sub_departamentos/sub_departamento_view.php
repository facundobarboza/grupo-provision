   ...
   <div class="row">
    ...
    <div class="col-md-4">
      <div class="form-group has-feedback">
        ...
        <input type="text" class="form-control" name="nombre_sub_departamento" id="nombre_sub_departamento" autocomplete="off" autofocus maxlength="32" value="<? echo $nombre_sub_departamento;?>">
