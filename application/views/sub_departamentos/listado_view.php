...
<div class="row">
    <div class="col-md-12" align="right">
        <input type="button" id='nuevo-sub-departamento' value="Nuevo Sub-Departamento" class="btn btn-primary"
            title="Agregar un nuevo sub-departamento "><br>
    </div>
</div><!-- /.row -->
<div class="row">
                ...
                <tr>
                    ...
                    <td width="60px">
                        ...
                        <div class="text-center">
                            <button type="button" class="btn btn-default btn-xs btn-modificar-sub-departamento"
                    ...
                    <td width="60px">
                        <div class="text-center">
                            &nbsp;&nbsp;&nbsp;
                            <button type="button" class="btn btn-default btn-xs btn-eliminar-sub-departamento"
...
<!-- Modal -->
<div class="modal fade" id="modal-sub-departamento" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    aria-hidden="true">
