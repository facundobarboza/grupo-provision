...
<div class="row">
    ...
    <div class="col-md-4">
      <div class="form-group has-feedback">
        ...
        <input type="text" class="form-control" name="codigo_patilla" id="codigo_patilla" autocomplete="off"  maxlength="32" value="<? echo $codigo_patilla?>">
    ...
    <div class="col-md-4">
      <div class="form-group has-feedback">
        ...
        <input type="text" class="form-control" name="codigo_color" id="codigo_color" autocomplete="off"  maxlength="32" value="<? echo $codigo_color?>">
        <span class="glyphicon glyphicon-remove form-control-feedba
        ck hide"></span>
...
<div class="row">
    ...
    <div class="col-md-4">
      <div class="form-group has-feedback">
        ...
        <input type="text" class="form-control" name="nro_codigo_interno" id="nro_codigo_interno" autocomplete="off"  maxlength="32" value="<? echo $nro_codigo_interno?>">
        <span class="glyphicon glyphicon-remove form-control-feedba
        ck hide"></span>
...
<div class="row">
    ...
    <div class="col-md-4">
      <div class="form-group has-feedback">
        ...
        <input type="text" class="form-control" name="letra_color_interno" id="letra_color_interno" autocomplete="off"  maxlength="32" value="<? echo $letra_color_interno?>">
        <span class="glyphicon glyphicon-remove form-control-feedba
        ck hide"></span>
...
<div class="row">
    ...
    <div class="col-md-4">
      <div class="form-group has-feedback">
        ...
        <input type="text" class="form-control" onkeypress="return filtrar_teclas(event,'0123456789');" name="cantidad" id="cantidad" autocomplete="off"  maxlength="32" value="<? echo $cantidad?>">
        <span class="glyphicon glyphicon-remove form-control-feedba
        ck hide"></span>
    ...
    <div class="col-md-4">
      <div class="form-group has-feedback">
        ...
        <input type="text" class="form-control" onkeypress="return filtrar_teclas(event,'0123456789');"  name="cantidad_minima" id="cantidad_minima" autocomplete="off"  maxlength="32" value="<? echo $cantidad_minima?>">
        <span class="glyphicon glyphicon-remove form-control-feedba
        ck hide"></span>
...
<div class="row">
    ...
    <div class="col-md-4">
      <div class="form-group has-feedback">
        ...
        <input type="text" class="form-control" onkeypress="return filtrar_teclas(event,'0123456789,');"  name="costo" id="costo" autocomplete="off"  maxlength="32" value="<? echo $costo?>">
        <span class="glyphicon glyphicon-remove form-control-feedba
        ck hide"></span>
    ...
    <div class="col-md-4">
      ...
      <div class="form-group has-feedback">
        ...
        <input type="text" class="form-control" onkeypress="return filtrar_teclas(event,'0123456789,');" name="precio_venta" id="precio_venta" autocomplete="off"  maxlength="32" value="<? echo $precio_venta?>">
        <span class="glyphicon glyphicon-remove form-control-feedba
        ck hide"></span>
