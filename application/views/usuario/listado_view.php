        ...
        <tr>
          ...
          <td width="160px">
            ...
            <div class="text-center">
              <button type="button" class="btn btn-default btn-xs btn-modificar-usuario" title="Modificar usuario">
                <span class="glyphicon glyphicon-pencil"></span>
              </button>
              &nbsp;&nbsp;&nbsp;
              <button type="button" class="btn btn-default btn-xs btn-eliminar-usuario" title="Eliminar usuario">
