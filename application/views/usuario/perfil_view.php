  ...
  <div class="row">
    <div class="col-md-4">
      <div class="form-group has-feedback">
        ...
        <input type="password" class="form-control" name="contrasenia_actual" id="contrasenia_actual" autofocus maxlength="32">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group has-feedback">
            ...
            <input type="password" class="form-control" name="contrasenia_nueva_1" id="contrasenia_nueva_1" maxlength="32">
            <span class="glyphicon glyphicon-remove form-control-feedback hide"></span>
          </div>
        </div>
        ...
        <div class="col-md-6">
          <div class="form-group has-feedback">
            ...
            <input type="password" class="form-control" name="contrasenia_nueva_2" id="contrasenia_nueva_2" maxlength="32">
            <span class="glyphicon glyphicon-remove form-control-feedback hide"></span>
          </div>
        </div>
      </div><!-- /.row -->
