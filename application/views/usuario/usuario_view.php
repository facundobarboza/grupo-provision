  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <div class="form-group has-feedback">
        ...
        <input type="text" class="form-control" name="nombre_usuario" id="nombre_usuario" autocomplete="off" autofocus maxlength="32" value="<? echo $nombre?>">
    ...
    <div class="col-md-4">
      <div class="form-group has-feedback">
        ...
        <input type="text" class="form-control" name="apellido_usuario" id="apellido_usuario" autocomplete="off" autofocus maxlength="50" value="<? echo $apellido?>" >
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <div class="form-group has-feedback">
        ...
        <input type="text" class="form-control" name="user_name" id="user_name" autocomplete="off" autofocus maxlength="15" value="<? echo $user_name?>">
        <span class="glyphicon glyphicon-remove form-control-feedback hide"></span>
     ...
     <div class="col-md-4">
      <div class="form-group has-feedback">
          ...
          <input type="password" name="contrasenia_usuario" id="contrasenia_usuario" maxlength="32" class="form-control">
          <span class="glyphicon glyphicon-remove form-control-feedback hide"></span>
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <div class="form-group has-feedback">
        ...
        <input type="text" class="form-control" name="mail_usuario" id="mail_usuario" autocomplete="off" autofocus maxlength="30" value="<? echo $mail?>" >
        <span class="glyphicon glyphicon-remove form-control-feedback hide"></span>
